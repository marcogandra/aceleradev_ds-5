...
# 3. URL do arquivo: https://archive.ics.uci.edu/ml/machine-learning-databases/00372/HTRU2.zip
...
#baixa o arquivo do site
URL = "https://archive.ics.uci.edu/ml/machine-learning-databases/00372/HTRU2.zip"

url = urlopen(URL)
output = open('pulsar.zip', 'wb')    
output.write(url.read())
output.close()

pulsar = ZipFile("pulsar.zip").open("HTRU_2.csv")

stars = pd.read_csv(pulsar)
...
def q5():
    ...
    return (* diff_scaled_norm_quantiles,)
